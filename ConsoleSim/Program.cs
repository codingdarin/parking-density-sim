        ...
        private static void Main(string[] args)
        {
            ...
            switch (command)
            {
                ...
                case "v2report":
                    ...
                    break;
                case "v2switch":
                    Scenarios.V2CoreSwitchDemo.Run();
                    break;
                case "v2final":
                ...
                case "v2complexdensity":
                    ...
                    break;
                case "v2disturb":
                    Scenarios.V2DisturbanceSweepDemo.Run();
                    break;
                case "v2battery":
                    Scenarios.V2BatteryHandoverDemo.Run();
                    break;
                case "v2sitezone":
                ...
                case "v2util":
                    ...
                    break;
                case "v2complexrobust":
                    Scenarios.V2ComplexRobustnessDemo.Run();
                    break;
                case "v2sitestaging":
                    Scenarios.V2SiteStagingCounterfactualDemo.Run();
                    break;
                case "v2site":
                    Scenarios.V2SiteDensityDemo.Run();
                    break;
                case "v2tradeoff":
                ...
                default:
                    Console.WriteLine("사용법: [layout|carry|multi|test|sanity|v2test|v2accessgate|v2scale|v2rolling|v2quality|v2pipeline|v2pdetail|v2pblock|v2papartment|v2pconstrained|v2pseeds|v2robots|v2arobots|v2corridor|v2caps|v2grid|v2crossing|v2orobots|v2pockets|v2pocketlayouts|v2finegrid|v2report|v2switch|v2final|v2density|v2complex|v2complexdensity|v2disturb|v2battery|v2site|v2sitestaging|v2sitezone|v2util|v2complexrobust|v2tradeoff|baseline|emergency|batch|d9|normal] [숫자] [--all]");
                    break;
            }
        }
