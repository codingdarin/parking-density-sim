...
namespace ParkingSim.Scenarios
{
    public static class V2PocketSweepDemo
    {
        public static void Run()
        {
            ...
            {
                "lanes,fire_m,vehicles,robots,pockets,net_alpha,success,ticks,seconds,safe_7min,expanded,elapsed_ms,reason",
            };
            ...
            string path = Path.Combine("output", "v2_pocket_sweep.csv");
